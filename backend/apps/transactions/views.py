...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'], url_path='approve-borrow', permission_classes=[IsManagerOrAdmin])
    ...
    @action(detail=True, methods=['post'], url_path='reject-borrow', permission_classes=[IsManagerOrAdmin])
    ...
    @action(detail=True, methods=['post'], url_path='approve-dispatch', permission_classes=[IsManagerOrAdmin])
    ...
    @action(detail=True, methods=['post'], url_path='reject-dispatch', permission_classes=[IsManagerOrAdmin])
    ...
    @action(detail=True, methods=['post'], url_path='approve-return', permission_classes=[IsManagerOrAdmin])
    def approve_return(self, request, pk=None):
        # Prepare new location data if provided
        new_location_data = {}
        if 'location' in request.data: new_location_data['location'] = request.data['location']
        if 'zone' in request.data: new_location_data['zone'] = request.data['zone']
        if 'cabinet' in request.data: new_location_data['cabinet'] = request.data['cabinet']
        if 'number' in request.data: new_location_data['number'] = request.data['number']
    ...
    @action(detail=True, methods=['post'], url_path='reject-return', permission_classes=[IsManagerOrAdmin])
    ...
    @action(detail=False, methods=['post'], url_path='bulk-approve', permission_classes=[IsManagerOrAdmin])
